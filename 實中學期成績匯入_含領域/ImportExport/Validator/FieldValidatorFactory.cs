...
namespace 實中學期成績匯入_含領域
{
    ...
    {
        private static Dictionary<string, List<string>> _studentdic;
        private static List<string> _studentiddic;
        public static Dictionary<string, string> _SubjectDomain;
        private static Dictionary<string, List<string>> GetStudent()
        {
            if (_studentdic != null)
                return _studentdic;
        ...
        private static List<string> GetStudentID()
        {
            if (_studentiddic != null)
                return _studentiddic;
            FISCA.Data.QueryHelper _queryHelper = new FISCA.Data.QueryHelper();
        ...
        public static  Dictionary<string,string> GetSubjectDomain()
        {
            if (_SubjectDomain != null)
                return _SubjectDomain;
            FISCA.Data.QueryHelper _queryHelper = new FISCA.Data.QueryHelper();
        ...
        public IFieldValidator CreateFieldValidator(string typeName, System.Xml.XmlElement validatorDescription)
        {
            ...
            switch (typeName.ToUpper())
            {
                case "STUDENTNUMBEREXISTENCE":
                    return new StudentNumberExistenceValidator(GetStudent());
                case "STUDENTNUMBERREPEAT":
                    return new StudentNumberRepeatValidator(GetStudent());
                case "ISDECIMAL2":
                ...
                case "IDEXISTENCE":
                    return new IdExistence(GetStudentID());
                default:
                    return null;
            }
        }
